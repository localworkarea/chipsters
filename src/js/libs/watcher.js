...
class ScrollWatcher {
	...
	scrollWatcherIntersecting(entry, targetElement) {
		...
		// 	const sectionPacks = document.querySelector('.packs');
		if (entry.isIntersecting) {
			// Бачимо об'єкт
			// Додаємо клас
			!targetElement.classList.contains('_watcher-view') ? targetElement.classList.add('_watcher-view') : null;
			
			// if (sectionPacks.classList.contains('_watcher-view')) {
			// 	headerEl.classList.add('_view');
			// }
			...
			// if (!sectionPacks.classList.contains('_watcher-view')) {
			// 	headerEl.classList.remove('_view');
			// }
